...
//    public static final String UPADTE_SURVEY_CALL_DET = "UPDATE appointment_remainder.survey_contact_det SET caller_response=:callerResponse, call_status=:callStatus, call_duration=:callDuration, call_retry_count=:retryCount,rec_upt_date=getdate() where contact_id=:contactId";
    ...
    public static final String COUNT_ACTIVE_CONTACT_DET = "SELECT COUNT(*) FROM appointment_remainder.active_contact_det WHERE status=:status";

    public static final String INSERT_SURVEY_CONTACT_DET = "insert into appointment_remainder.survey_contact_det (phone,actionId,Survey_Lang,MainSkillset,subSkillset,call_status) values (:phone,:actionId,:Survey_Lang,:MainSkillset,:subSkillset,:call_status)";
    ...
    public static final String GET_SURVEY_CONTACT_DET = "select MainSkillset,phone,actionId, Survey_Lang,subSkillset,call_status from appointment_remainder.survey_contact_det where call_status !='ANSWERED'";
