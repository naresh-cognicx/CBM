...
public class CampaignQueryConstant {
    ...
    public static final String GET_CAMPAIGN_DET = "SELECT campaign_id,name,description,status,max_adv_time,retry_delay,retry_count,concurrent_call,start_date,start_time,campaign_det.end_date,end_time,ftp_location,ftp_credentials,file_name,call_before FROM appointment_remainder.campaign_det where status = 1 ";
    ...
    public static final String INSERT_CONTACT_DET = "insert into appointment_remainder.contact_det (campaign_id,campaign_name,last_four_digits,customer_mobile_number,total_due,minimum_payment,due_date,language,call_status,upload_history_id,productId) values(:campaignId,:campaignName,:last_four_digits,:customer_mobile_number,:total_due,:minimum_payment,:due_date,:language,:callStatus,:historyId,:productId)";
    ...
    public static final String GET_CAMPAIGN_DET_RT = "select campaign_id,name,status,start_date,end_date,start_time,end_time,concurrent_call FROM appointment_remainder.campaign_det";
    ...
    public static final String UPDATE_ACTIVE_CONTACT_DET = "UPDATE appointment_remainder.active_contact_det SET status=:status WHERE calluid=:calluid AND productid=:productid AND connectedlinenum=:connectedlinenum";
    ...
    //	public static final String COUNT_ACTIVE_CONTACT_DET = "SELECT COUNT(*) FROM appointment_remainder.active_contact_det WHERE productid=:productId AND status=:status AND created_time >= DATEADD(MINUTE, -10, GETDATE());";
