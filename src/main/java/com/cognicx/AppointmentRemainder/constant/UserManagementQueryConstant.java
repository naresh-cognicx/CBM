...
public class UserManagementQueryConstant {
	...
	public static final String GET_USER_DET_BYID = "SELECT userKey,UserId,UserPassword,UserRole,EmailId,FirstName,LastName,MobNum,userGroup,PBXExtn,SkillSet,Agent from appointment_remainder.usermanagement_det where UserId=:UserId";

	public static final String GET_USER_DET_USERGROUP = "SELECT userKey,FirstName,LastName,EmailId,MobNum,UserId,UserPassword,UserRole,PBXExtn,SkillSet,Agent,userGroup  FROM appointment_remainder.usermanagement_det where userGroup=:groupName";
}
